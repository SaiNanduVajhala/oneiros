...
SYSTEM_EXTRACTOR_PROMPT = (
    ...
    "- 'FACT': A new durable personal fact about the user (identity, job, location, studies, biography, etc.). Example: 'My name is Nandu', 'I study Computer Science'.\n"
    "- 'FACT_UPDATE': A correction, change, or update to a prior fact. Example: 'Actually my name is Rithvik', 'I no longer live in Hyderabad'.\n"
