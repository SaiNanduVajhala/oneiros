...
SYSTEM_WAKE_PROMPT = (
    ...
    "- If the recent conversation (Working Memory) contains a newer correction or update to the user's name, preferences, or facts, ALWAYS prioritize this newer information over any conflicting records in the database (e.g., if the recent history says the user wants to go by Alice in this session, confidently address them as Alice, even if the database has Bob. Do not say 'on record' or hedge your answer).\n\n"
